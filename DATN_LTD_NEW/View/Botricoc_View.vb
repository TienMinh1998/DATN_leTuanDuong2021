...
Public Class Botricoc_View
    Private Shared _instance As Botricoc_View
    ' singleton new
    Public Shared ReadOnly Property Instance As Botricoc_View
        Get
            If _instance Is Nothing Then _instance = New Botricoc_View
            Return _instance
        End Get
    End Property
    Private Sub Botricoc_View_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ' lấy dữ liệu chiều sâu vừa nhập ở FRM trước
    ...
    Private Sub btn_sct_Click(sender As Object, e As EventArgs) Handles btn_sct.Click
        Try
            ...
            txtPcpt.Text = Tinh.Pcpt().ToString ' sức chịu tải thep cpt
            txtPspt.Text = Tinh.Pspt().ToString ' sức chịu tải théo spt
        Catch

        End Try
        If txtPspt.Text = "" Or txtPspt.Text = "" Or txtPvl.Text = "" Then
            MessageBox.Show("Chọn Chưa Nhập đủ các thông số địa chất hoặc vật liệu", "Thông báo hệ Thống", MessageBoxButtons.OK, MessageBoxIcon.Warning)
        End If
        Try
            If txtPcpt.Text = 0 Or txtPspt.Text = 0 Or txtPvl.Text = 0 Then
    ...
    Private Sub cbbSCT_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbbSCT.SelectedIndexChanged
        ' có 3 trường hợp chọn số cọc để tính
    ...
    Private Sub btn_kiemtra_Click(sender As Object, e As EventArgs) Handles btn_kiemtra.Click
        Try
            ...
            Else
                ...
                DATA.b = Convert.ToDouble(txtBd.Text)
                DATA.l = Convert.ToDouble(txtLd.Text)
    ...
    Private Sub BunifuButton1_Click(sender As Object, e As EventArgs) Handles BunifuButton1.Click
        txt_hmin.Text = Botricoc_controler.Hmin().ToString()
        Dim a As Double = Convert.ToDouble(txt_chieusauchonmong.Text)
        Dim b As Double = Convert.ToDouble(txt_hmin.Text)
        lbKiemtra.ForeColor = Color.Green
        lbKiemtra.Text = HamTinh.isHmin(a, b)
    ...
    Private Sub btn_luu_Click(sender As Object, e As EventArgs) Handles btn_luu.Click
        Try
            ...
            Else
                ...
                Dim frm As New RM_Kiemtradai
                Form1.Instance.OpenForm(frm)
            End If
        Catch
        End Try
